...
<html>
	...
	<body style="font-family: 'Roboto', sans-serif;">
		<div class="container-fluid" style="background-color: #C4C4C4; height: 50px">
			<div class="row justify-content-between">
				<div class="col-2" style="font-size: 24px; margin: 6px;">
					<a href="/v1/index" style="color: black">Portal API</a>
				</div>
				<div class="col-2" style="font-size: 24px; color: #646464; margin: 6px">
					Date : ${Date.date}/${Date.month+1}/${1900+Date.year}
				</div>
			</div>
		</div>
		<div class="container-fluid" style="margin-top: 20px">
			<div class="row justify-content-center">
				<div class="col-3">
					<a href="/v1/education/university"><button type="button" class="btn btn-primary" style="width:352px; height:121px; font-size: 24px"><span style="font-family: 'Roboto', sans-serif;">ข้อมูลพื้นฐานสถาบันอุดมศึกษา<br>ปีการศึกษา 2563</span></button></a>
				</div>
				<div class="col-3">
					<a href="/v1/education/demonstration"><button type="button" class="btn btn-primary" style="width:352px; height:121px; font-size: 24px"><span style="font-family: 'Roboto', sans-serif;">รายชื่อโรงเรียนสาธิต<br>ในสถาบันอุดมศึกษา</span></button></a>
				</div>
				<div class="col-3">
					<a href="/v1/education/demonstration/nameandsex"><button type="button" class="btn btn-primary" style="width:352px; height:121px; font-size: 24px"><span style="font-family: 'Roboto', sans-serif;">จำนวนนักเรียนโรงเรียนสาธิต<br>ปีการศึกษา 2563<br>จำแนกตาม ชื่อโรงเรียน และเพศ</span></button></a>
				</div>
			</div>
		</div>
		<div class="container-fluid" style="margin-top: 20px">
